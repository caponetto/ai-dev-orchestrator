...
- **You have a strict 30-minute time budget.** Prioritize producing a complete, valid output over exhaustive analysis. If time is running short, finalize and write what you have rather than starting new work.
